...
AB<-results.df[which(results.df[,2]=="AB"),]
BC<-results.df[which(results.df[,2]=="BC"),]
AC<-results.df[which(results.df[,2]=="AC"),]
...
png(filename="ab_recovery_motif2a4.png");

plot(x_ordre, ABmotif2, xlab="Blast similarity (%)",ylab="Unifrac_res",main="Global unifrac_res measures\n for AbRecovery Dataset", col="deepskyblue3",ylim=c(0,1),type="l", lty=1)
...
points(x_ordre, ACmotif4, type="l", lty=3, col="green")
		...
		legend("topright",legend=c("AB","BC","AC", "motif size 2","motif size 3","motif size 4"),title="Color match and motif size",col=c("deepskyblue3","orangered2","green","black","black","black"), lty=c(1,1,1,1,2,3))
...
png(filename="ab_recovery_motif3_isoclass.png");
...
points(x_ordre, ACisoclass2, type="l", lty=2, col="green")
		...
		legend("topright",legend=c("AB","BC","AC", "isoclass 3","isoclass 2"),title="Color match and motif size",col=c("deepskyblue3","orangered2","green","black","black"), lty=c(1,1,1,1,2))
...
png(filename="ab_recovery_motif4_isoclass.png");
...
legend("topright",legend=c("AB","BC","AC", "isoclass 10","isoclass 9","isoclass 8","isoclass 7","isoclass 6","isoclass 4"),title="Color match and motif size",col=c("deepskyblue3","orangered2","green","black","black","black","black","black","black"), lty=c(1,1,1,1,2,3,4,5,6))
dev.off()
